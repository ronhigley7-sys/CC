...
(function(){
  ...
  function fitScript(){return '<script id="cc-fit-one-page">(function(){function fit(){try{var p=document.querySelector(".ps-page")||document.body;document.body.style.zoom="1";var h=p.scrollHeight||p.getBoundingClientRect().height,max=8.95*96;var z=Math.min(1,max/h);document.body.style.zoom=String(Math.max(.62,z));}catch(e){}}window.addEventListener("load",function(){fit();setTimeout(function(){fit();window.print();},180);});})();<\/script>';}
