...
(function(){
  ...
  function list(order,empty){if(!order.length)return '<div style="padding:2px 3px;color:#6b7280;font-style:italic;font-size:6.7pt;line-height:1;">'+empty+'</div>';return order.map((n,i)=>{const suf=i===0?'st':i===1?'nd':i===2?'rd':'th',badge=isAgency(n)?' <span style="font-size:5.5pt;font-weight:800;color:#7c2d12;background:#ffedd5;border:1px solid #fdba74;padding:0 2px;border-radius:2px;">AGENCY</span>':'';return '<div style="padding:1px 3px;border-bottom:1px solid #dbe5ef;font-size:6.8pt;line-height:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;'+(i===0?'font-weight:800;color:#0f4c81;background:#e0f2fe;':'')+'"><b style="display:inline-block;width:19px;">'+(i+1)+suf+'</b>'+esc(n)+badge+'</div>';}).join('');}
  function rnBlock(d){const day=buildRN(d,'DAY'),night=buildRN(d,'NIGHT');return '<div class="first-admission-print admission-rotation-print" style="margin:3px 0 0;padding:3px 4px;border:1px solid #0f4c81;border-radius:3px;background:#f8fbff;page-break-inside:avoid;"><div style="font-size:7.5pt;font-weight:800;text-transform:uppercase;color:#0f4c81;margin-bottom:2px;line-height:1;">RN Admission Order <span style="font-size:5.8pt;font-weight:500;color:#64748b;">Leadership requirement</span></div><table style="width:100%;border-collapse:collapse;table-layout:fixed;"><tr><th style="width:50%;border:1px solid #9fbad0;padding:2px;background:#eef6ff;font-size:7pt;line-height:1;">☀ Day</th><th style="width:50%;border:1px solid #9fbad0;padding:2px;background:#eef6ff;font-size:7pt;line-height:1;">🌙 Night</th></tr><tr><td style="border:1px solid #9fbad0;vertical-align:top;padding:0;">'+list(day,'No eligible 3B RN')+'</td><td style="border:1px solid #9fbad0;vertical-align:top;padding:0;">'+list(night,'No eligible 3B RN')+'</td></tr></table></div>';}
  function caBlock(d){const orders=CA_SHIFTS.map(s=>buildCA(d,s.key));return '<div class="ca-admission-print admission-rotation-print" style="margin:3px 0 0;padding:3px 4px;border:1px solid #0e7490;border-radius:3px;background:#f5fcfd;page-break-inside:avoid;"><div style="font-size:7.5pt;font-weight:800;text-transform:uppercase;color:#0e7490;margin-bottom:2px;line-height:1;">CA Admission Order <span style="font-size:5.8pt;font-weight:500;color:#64748b;">Leadership requirement</span></div><table style="width:100%;border-collapse:collapse;table-layout:fixed;"><tr>'+CA_SHIFTS.map(s=>'<th style="border:1px solid #8cc7d1;padding:2px 1px;background:#ecfeff;font-size:6.3pt;line-height:1;">'+s.label.replace(' 0630–1430','').replace(' 1430–1830','').replace(' 1830–2230','').replace(' 2230–0630','')+'</th>').join('')+'</tr><tr>'+orders.map(a=>'<td style="border:1px solid #8cc7d1;vertical-align:top;padding:0;">'+list(a,'No eligible CA')+'</td>').join('')+'</tr></table></div>';}
  function css(){return '<style id="cc-one-page-print-fix">@page{size:letter portrait!important;margin:.18in .22in!important}@media print{html,body{margin:0!important;padding:0!important}.ps-page{padding:0!important;margin:0 auto!important;max-width:none!important;width:100%!important;min-height:10.35in!important;height:auto!important;display:flex!important;flex-direction:column!important;justify-content:space-between!important}.ps-title{font-size:18pt!important;margin:0 0 2px!important;line-height:1!important}.ps-date{font-size:9pt!important;margin:0 0 4px!important}.ps-section-label{font-size:9pt!important;margin:4px 0 1px!important;padding-bottom:1px!important}.ps-table{margin-bottom:2px!important}.ps-table th{font-size:7.8pt!important;padding:2px!important;line-height:1!important}.ps-table td{font-size:8pt!important;padding:2px!important;line-height:1.02!important}.ps-notes-label{font-size:7pt!important}.ps-notes-text{font-size:7.5pt!important;line-height:1!important}.ps-footer{font-size:6pt!important;margin-top:3px!important;padding-top:2px!important}.first-admission-print,.ca-admission-print{margin-top:3px!important;padding:3px 4px!important;break-inside:avoid!important;page-break-inside:avoid!important}.admission-rotation-print table{line-height:1!important}}</style>';}
